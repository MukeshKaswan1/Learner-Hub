...
const Course = () => {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        "http://localhost:5000/courses/getCourse",
        {
          classCode: classCode,
        },
  ...
  useEffect(async () => {
    if (storeData.token) {
      ...
      axios
        .post(
          "http://localhost:5000/courses/getReminders",
          {
        ...
        .then(async (res) => {
          ...
          for (let reminder of res.data) {
            await axios
              .post("http://localhost:5000/courses/getCourse", {
  ...
  const deleteClass = () => {
    axios
      .delete(
        "http://localhost:5000/courses/deleteCourse",
        {
